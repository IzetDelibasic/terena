class Venue {
  ...
  bool get hasChangingRooms => amenities?.contains('Changing Rooms') ?? false;
  bool get hasEquipmentRental =>
      amenities?.contains('Equipment Rental') ?? false;
  bool get hasCafeBar => amenities?.contains('Cafe/Bar') ?? false;
}
